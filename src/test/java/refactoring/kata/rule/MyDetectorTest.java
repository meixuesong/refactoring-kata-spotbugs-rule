...
public class MyDetectorTest {
    ...
    public void testGoodCase() {
        Path path = Paths.get("target/test-classes", "refactoring.kata.rule".replace('.', '/'), "GoodCase.class");
    ...
    public void testBadCase() {
        Path path = Paths.get("target/test-classes", "refactoring.kata.rule".replace('.', '/'), "BadCase.class");
        BugCollection bugCollection = spotbugs.performAnalysis(path);
